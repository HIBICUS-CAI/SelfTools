...
sudo apt-get install openssh-server g++ gdb make ninja-build rsync zip git zsh pip vulkan-tools libvulkan-dev vulkan-validationlayers spirv-tools libxxf86vm-dev libxi-dev libglfw3-dev libglm-dev glslc -y
